...
public class TransactionServiceImplTest {
    ...
    public void testGetAllTransactionsByCourseId() {
        ...
        Mockito.when(transactionRepository.findAllByCourseId(givenCourseId, pageable)).thenReturn(transactionList);
    ...
    public void testGetAllTransactionsByStudentId() {
        ...
        Mockito.when(transactionRepository.findAllByStudentId(givenStudentId, pageable)).thenReturn(transactionList);
